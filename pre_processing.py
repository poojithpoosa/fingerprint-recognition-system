...
def makeTrainImages(img_path, finger_id, j, save_url = 'G:\\akhil project\\contact-based_fingerprints\\new\\'):
    finger_idx = 1
...
contact_images = "G:\\akhil project\\contact-based_fingerprints\\first_session\\"
from os.path import join
print(contact_images)
for finger_id in range(1, 10 + 1):
    print(f"[*] creating {finger_id}...")
    all_images = glob(join(contact_images, '1_1.jpg'))
